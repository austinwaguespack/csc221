...
# returns: boolean
def test_is_odd():
    assert hw4_solution.is_odd(4) == False
    assert hw4_solution.is_odd(3) == True
...
# returns: boolean
def test_is_even():
    assert hw4_solution.is_even(4) == True
    assert hw4_solution.is_even(3) == False
...
def test_is_mult_of_four():
    assert hw4_solution.is_mult_of_four(4) == True
    assert hw4_solution.is_mult_of_four(5) == False
...
def test_is_mult_of_divisor():
    assert hw4_solution.is_mult_of_divisor(4, 2) == True
    assert hw4_solution.is_mult_of_divisor(5, 2) == False
...
def test_both_ends():
    ...
    assert hw4_solution.both_ends('abd') == ('abbc')
    assert hw4_solution.both_ends('ab') == ('abab')
    assert hw4_solution.both_ends('abcd') == ('abcd')
    assert hw4_solution.both_ends('') == ('')
